...
#        --max_grad_norm 0.0 {line_break}"""
  ...
  --max_grad_norm 0.0 {line_break}"""
    ...
    clip_path = resolve_path("/teamspace/studios/this_studio/models/clip/clip_l.safetensors")
    t5_path = resolve_path("/teamspace/studios/this_studio/models/clip/t5xxl_fp16.safetensors")
    ae_path = resolve_path("/teamspace/studios/this_studio/models/vae/ae.safetensors")
  ...
  --output_dir /teamspace/studios/this_studio/models/loras {line_break}
